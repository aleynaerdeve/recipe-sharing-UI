...
export class RecipeCardComponent {
  ...
  ngOnInit(){
   ...
   handleLikeRecipe(id: any) {
    this.recipeService.likeRecipe(id).subscribe();
  }

  isLiked(recipe: any): boolean {
    // Adjust this condition based on how you determine if a recipe is liked
    return recipe.likes && recipe.likes.length > 0;
  }
